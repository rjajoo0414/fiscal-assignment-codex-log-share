...
Unlocked messages are rendered as Markdown. Codex subagent notification payloads are treated as assistant messages, then unwrapped and rendered from their completed/failed status text instead of showing raw JSON.
